/**
 * Author: dont know, copied from https://github.com/tdas0/lib/blob/167a9addab22577e8cd9cfd77b6d3225aa912639/library/misc/matroid.cpp
 ...
 * Time: O(N^2 * R * (C1 + C2)), N = size of ground set,R = rank of intersection,
 * C1 e C2 custos dos oráculos (abaixo C1 == 1 , C2 = 62)
 * Description: Given two matroids, finds the largest possible set that is
 * considered independent by both matroids. You can think of matroids as a
