...
\section{Misc. algorithms}
	...
	\kactlimport{Matroid.h}
	\kactlimport{ParallelBinarySearch.h}

	\subsection{Monotonic Nim: Non-decreasing}
	If n is odd, compute xor of $(a_{2i+1}-a_{2i})$, else prepend 0 to the beginning and repeat.

	\subsection{Warnsdorf's rule}
	Always move the knight to an adjacent square with minimal degree
