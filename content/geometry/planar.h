/**
 * Author: unknown, copied from https://cp-algorithms.com/geometry/planar.html
 * Description: Given a set of points and line segments between these points, 
 * compute the graph composed of the faces of this embedding. This implementation returns a
 * vector of vertices for each face, outer face goes first. Inner faces are returned in
 * counter-clockwise orders and the outer face is returned in clockwise order.
 * Time: $O(n log n)$
*/
